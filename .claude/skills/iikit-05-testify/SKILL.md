...
```powershell
# Store in context.json (primary)
pwsh .claude/skills/iikit-core/scripts/powershell/testify-tdd.ps1 store-hash "FEATURE_DIR/tests/test-specs.md" ".specify/context.json"

# Store as git note (tamper-resistant backup)
pwsh .claude/skills/iikit-core/scripts/powershell/testify-tdd.ps1 store-git-note "FEATURE_DIR/tests/test-specs.md"
```
...
Read [testspec-template.md](.claude/skills/iikit-core/templates/testspec-template.md) for the standard structure.
