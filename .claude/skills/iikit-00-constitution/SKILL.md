...
4. **Consistency propagation** (validate against templates if they exist):
   - Check [plan-template.md](.claude/skills/iikit-core/templates/plan-template.md) for constitution alignment
   - Check [spec-template.md](.claude/skills/iikit-core/templates/spec-template.md) for scope/requirements alignment
   - Check [tasks-template.md](.claude/skills/iikit-core/templates/tasks-template.md) for task categorization alignment
