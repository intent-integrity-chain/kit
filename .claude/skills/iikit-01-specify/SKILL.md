...
bash .claude/skills/iikit-core/scripts/bash/create-new-feature.sh --json "$ARGUMENTS" --short-name "your-short-name"

# Without branch creation (if user declined):
bash .claude/skills/iikit-core/scripts/bash/create-new-feature.sh --json --skip-branch "$ARGUMENTS" --short-name "your-short-name"
```

**Windows (PowerShell):**
```powershell
# With branch creation (default):
pwsh .claude/skills/iikit-core/scripts/powershell/create-new-feature.ps1 -Json "$ARGUMENTS" -ShortName "your-short-name"

# Without branch creation (if user declined):
pwsh .claude/skills/iikit-core/scripts/powershell/create-new-feature.ps1 -Json -SkipBranch "$ARGUMENTS" -ShortName "your-short-name"
```
...
Read [spec-template.md](.claude/skills/iikit-core/templates/spec-template.md) to understand required sections.
