...
1. Run prerequisites check:
   ```bash
   bash .tessl/tiles/intent-integrity-chain/kit/skills/iikit-core/scripts/bash/check-prerequisites.sh --json --require-tasks --include-tasks
   ```
...
*Generated from tasks.md by /iikit-09-taskstoissues*
*Feature: [###-feature-name]*
```

**Issue Labels** (create if they don't exist):
- `iikit` - All intent-integrity-kit generated issues
