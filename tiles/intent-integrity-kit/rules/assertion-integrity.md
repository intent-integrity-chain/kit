...
- NEVER delete, modify, or disable IIKit's pre-commit enforcement — either `.git/hooks/pre-commit` (default install) or `.git/hooks/iikit-pre-commit` plus the chain-call in your existing hook (install-alongside)
